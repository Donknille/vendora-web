...
**Abnahme:** neuer User = Trial (42 Tage, Vollzugriff) ✅; nach Trial Free/Nur-Lese ✅; Create + GuV-Export serverseitig 403 `PRO_REQUIRED` ✅; Rechnungs-PDF/DSGVO-Export für Free frei ✅; Alt-User-Migration (aktive Abos → pro) ✅. **Operativ offen:** Stripe-Pro-Produkt (9,99 € brutto) anlegen + `STRIPE_PRICE_ID` setzen; End-to-End-Kauf im Stripe-Testmode verifizieren.
