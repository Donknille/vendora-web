    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Card>
        ...
        <div className="space-y-2 text-sm text-secondary leading-relaxed">
          ...
          <p>(2) Nach Ablauf der Testphase ist das kostenpflichtige Abonnement &bdquo;Bilanz-Buddy Pro&ldquo; (14,99 €/Monat inkl. gesetzlicher Umsatzsteuer) erforderlich, um neue Einträge anzulegen (insbesondere Aufträge, Rechnungen, Märkte, Verkäufe und Ausgaben) sowie um eine GuV-/EÜR-Jahresübersicht zu erstellen und Daten zu importieren.</p>
