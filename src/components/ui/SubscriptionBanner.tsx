...
export function SubscriptionBanner() {
  ...
  const message = isTrial
    ...
    : de
      ? "Nur-Lese-Modus: Zum Anlegen und für die GuV Bilanz-Buddy Pro (14,99 €/Monat inkl. USt.). Belege bleiben herunterladbar."
      : "Read-only: Bilanz-Buddy Pro (€14.99/month incl. VAT) is required to create entries and the P&L. Existing documents stay downloadable.";
