...
const translations = {
  en: {
    ...
    help: {
      title: "Help",
      subtitle: "How Bilanz-Buddy works — in five minutes.",
      nav: "Help",
      ...
      tour: {
        ...
        welcome: {
          title: "Welcome to Bilanz-Buddy",
          body: "Bilanz-Buddy covers everything between the market stall and the tax return: record sales, write orders and invoices, keep track of expenses — and at the end of the year the P&L is already there. Three short steps and you know your way around.",
        },
        markets: {
      ...
      install: {
        ...
        body: "Bilanz-Buddy can live on your home screen: its own icon, full screen without an address bar, one tap instead of browser and bookmark. If the signal drops at the stall, the register you already have open keeps running and hands in the sales later.",
        action: "Add to home screen",
        installed: "Bilanz-Buddy is installed on this device.",
        ...
        unsupported:
          "Your browser does not offer a direct install. The browser menu usually still has an option to save Bilanz-Buddy as an app — and everything works in a normal browser tab either way.",
        hintTitle: "Bilanz-Buddy as an app",
        hintBody: "Put Bilanz-Buddy on your home screen — then the register is one tap away at the stall.",
        hintAction: "Install",
  ...
  de: {
    ...
    help: {
      ...
      tour: {
        ...
        welcome: {
          title: "Willkommen bei Bilanz-Buddy",
          body: "Bilanz-Buddy deckt ab, was zwischen Marktstand und Steuererkl\u00E4rung anf\u00E4llt: Verk\u00E4ufe erfassen, Auftr\u00E4ge und Rechnungen schreiben, Ausgaben festhalten \u2014 und am Jahresende steht die E\u00DCR schon da. Drei kurze Schritte, dann kennst du den Weg.",
        },
        markets: {
      ...
      install: {
        ...
        body: "Bilanz-Buddy kann auf dem Startbildschirm liegen: eigenes Symbol, Vollbild ohne Adressleiste, ein Tipp statt Browser und Lesezeichen. Bricht am Stand das Netz weg, l\u00E4uft die bereits ge\u00F6ffnete Kasse weiter und reicht die Verk\u00E4ufe sp\u00E4ter nach.",
        action: "Auf dem Startbildschirm speichern",
        installed: "Bilanz-Buddy ist auf diesem Ger\u00E4t installiert.",
        ...
        unsupported:
          "Dein Browser bietet keine direkte Installation an. \u00DCber das Browsermen\u00FC l\u00E4sst sich Bilanz-Buddy meist trotzdem als App speichern \u2014 und im normalen Browser-Tab funktioniert ohnehin alles.",
        hintTitle: "Bilanz-Buddy als App",
        hintBody: "Leg Bilanz-Buddy auf den Startbildschirm \u2014 dann ist die Kasse am Stand einen Tipp entfernt.",
